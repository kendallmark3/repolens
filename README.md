...
This workspace holds the **Repo Scope** project — an enterprise repository discovery and intelligence platform built with [Intent-Driven Engineering](https://intent-driven-engineering.com).
...
For everything about the product (features, architecture, running it locally, known limitations), go to [`repo-scope/README.md`](repo-scope/README.md).
